...
public class DataManagementPreferenceFragment extends BasePreferenceFragment {
    ...
    private static final String KEY_VIDEO_ALBUM = "key_video_album";
    private static final String KEY_SPONSORS = "key_sponsors";
    ...
    public boolean onPreferenceTreeClick(Preference preference) {
        switch (preference.getKey()) {
            ...
            case KEY_BLOG_ANIMAL:
                ...
                break;
            case KEY_SPONSORS:
                DataManagementActivity.start(getContext(), BZFireBaseApi.sponsors);
                break;
            ...
            case KEY_PHOTO_ALBUM:
                ...
                break;
            case KEY_VIDEO_ALBUM:
                DataManagementActivity.start(getContext(), BZFireBaseApi.video_album);
                break;
        }
